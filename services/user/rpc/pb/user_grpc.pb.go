...
const (
	...
	User_FindSingleUser_FullMethodName           = "/service.User/FindSingleUser"
...
func (c *userClient) FindSingleUser(ctx context.Context, in *FindSingleUserRequest, opts ...grpc.CallOption) (*FindSingleUserResponse, error) {
	out := new(FindSingleUserResponse)
	err := c.cc.Invoke(ctx, User_FindSingleUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	// 查找指定用户
	FindSingleUser(context.Context, *FindSingleUserRequest) (*FindSingleUserResponse, error)
	// 查找所有用户
...
func (UnimplementedUserServer) FindSingleUser(context.Context, *FindSingleUserRequest) (*FindSingleUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindSingleUser not implemented")
}
...
func _User_FindSingleUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindSingleUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).FindSingleUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_FindSingleUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).FindSingleUser(ctx, req.(*FindSingleUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FindSingleUser",
			Handler:    _User_FindSingleUser_Handler,
		},
		{
